...
<script type="text/javascript">
    ...
    var onFormSubmit = function ($dialog, $grid) {
        var url = '../ajax/Srv_Attendance.ashx/ImportAttendanceDetail';
            //判断是否有报表上传
            if ($('#report').val() == "") {
    ...
    $(function () {
        ...
        $("#file_upload").uploadify({
            ...
            //在文件上传时需要一同提交的数据
            'formData': { 'floderName': 'WorkAttendance' },
            'buttonText': '选择文件',
            //flash
...
<form method="post">
    <table class="table table-bordered  table-hover">
        <tr>
            <td colspan="2" style="font-weight:700;font-size:14px;text-align:center;line-height:20px;">请上传<%=DateTime.Now.AddMonths(-1).ToString("yyy年MM月") %>签到记录
                <hr />
            </td>
        </tr>
        <tr>
