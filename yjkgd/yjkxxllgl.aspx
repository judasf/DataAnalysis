<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yjkxxllgl.aspx.cs" Inherits="yjkxxllgl" %>
...
<body>
    ...
    <div id="content">
       <p class="sitepath">
            <b>当前位置：</b>应急库事项管理 > <a href="yjkxxllgl.aspx">应急库领料信息管理</a>
        </p>
        <p style="text-align: left;line-height:30px;">
         ...
         <b>领料单位：</b><asp:DropDownList ID="lldw" runat="server">
                      ...
                      <b>编号：</b><asp:TextBox ID="yjkid" runat="server"></asp:TextBox>
                    </p>
