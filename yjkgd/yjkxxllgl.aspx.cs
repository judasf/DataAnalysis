...
public partial class yjkxxllgl : System.Web.UI.Page
{
    ...
    {
        string sql = "select typename from yjylkc_Type  a join yjylkc_Class b on a.classid=b.classid where b.classname ='应急库'";
    ...
    private void NewsBind()
    {
        ...
        if (Request.QueryString["yjkid"] != null)
        {
            condition += "&yjkid=" + Request.QueryString["yjkid"].ToString();
        }
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        ...
        outputFileName += "应急库领料明细表.xls";
        DataTable dt = GetDataTable();

        dt.Columns[0].ColumnName = "序号";
        dt.Columns[1].ColumnName = "应急库编号";
        dt.Columns[2].ColumnName = "出库时间";
        dt.Columns[3].ColumnName = "领料单位";
        dt.Columns[4].ColumnName = "物资类别";
        dt.Columns[5].ColumnName = "物资型号";
