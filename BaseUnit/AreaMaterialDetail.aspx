...
<head>
    ...
    <script type="text/javascript">
        ...
        var exportAreaMaterialDetail = function () {
            jsPostForm('../ajax/Srv_CustomAccess_Stock.ashx/ExportAreaMaterialDetail', $.serializeObject($('#searchForm')));
        };
        //导入装维片区用料明细
        ...
        $(function () {
            grid = $('#grid').datagrid({
                title: '装维片区用料明细',
                url: '../ajax/Srv_CustomAccess_Stock.ashx/GetAreaMaterialDetail',
                striped: true,
                rownumbers: true,
                pagination: true,
                singleSelect: true,
...
<body class="easyui-layout" style="overflow: hidden;">
    ...
    <div data-options="region:'center',fit:true,border:false">
        <p class="sitepath">
            <b>当前位置：</b>客户接入事项管理 > <a href="javascript:void(0);">客户接入——装维片区用料明细</a>
        </p>
