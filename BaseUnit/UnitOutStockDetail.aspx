...
<head>
    ...
    <script type="text/javascript">
        ...
        var exportOutStockDetail = function () {
            jsPostForm('../ajax/Srv_khjr_Stock.ashx/ExportUnitOutStockDetail', $.serializeObject($('#searchForm')));
        };
        $(function () {
            grid = $('#grid').datagrid({
                title: '装维片区领料明细',
                url: '../ajax/Srv_khjr_Stock.ashx/GetUnitOutStockDetail',
                striped: true,
                rownumbers: true,
                pagination: true,
                singleSelect: true,
...
<body class="easyui-layout" style="overflow: hidden;">
    ...
    <div id="toolbar" style="display: none; padding: 5px 10px 0;">
        <form id="searchForm" style="margin: 0;">
            <table>
                ...
                <tr>
                    <td colspan="7" style="text-align: left;padding-left:100px;">物料型号：<input name="typeid" id="typeid" class="combo easyui-combobox" style="width: 200px;" data-options="valueField: 'id',textField: 'text', editable: false,panelHeight: '200',url: '../ajax/Srv_khjr.ashx/GetWlxhComboboxAll'" />
    ...
    <div data-options="region:'center',fit:true,border:false">
        <p class="sitepath">
            <b>当前位置：</b>客户接入事项管理 > <a href="javascript:void(0);">客户接入——装维片区领料明细</a>
        </p>
