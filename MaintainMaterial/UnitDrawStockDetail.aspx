    ...
    <script type="text/javascript">
        ...
        var viewRepairMaterialDetail = function (id) {
            var dialog = parent.$.modalDialog({
                ...
                href: 'MaintainMaterial/DialogOP/ViewStockDrawMaterial_OP.aspx?id=' + id,
                buttons: [{
                    text: '关闭',
                    handler: function () {
                        dialog.dialog('close');
        ...
        $(function () {
            ...
            grid = $('#grid').datagrid({
                title: '领料明细',
                url: '../ajax/Srv_MaintainMaterial.ashx/GetUnitDrawStockDetail',
                striped: true,
                rownumbers: true,
                pagination: true,
                singleSelect: true,
                ...
                columns: [[{
                    ...
                    formatter: function (index, row) {
                        var str = '';
                        if (row.lldpath)
                            str += $.formatString('<a href="javascript:void(0);" data-mfp-src="../{0}"  title="点击查看领料单" class="showpic" style="cursor:pointer;text-decoration:none;color:#ff8800" >详情</a>', row.lldpath);
                        return str;
                    }
                }, {
                    width: '80',
...
<body class="easyui-layout" style="overflow: hidden;">
        ...
        <form id="searchForm" style="margin: 0;">
            <table>
                <tr>
                    ...
                    <td>
                        <select id="classname" class="combo easyui-combobox" name="classname" style="width: 140px;" data-options="panelHeight:'auto',editable: false,onSelect:function(rec){ var url = '../ajax/Srv_MaintainMaterial.ashx/GetMaintainMaterial_TypeInfoComboboxAll?classname='+encodeURIComponent(rec.value);$('#typeid').combobox('reload', url); }">
                ...
                <tr>
                    ...
                    <td>
                        <select id="unitname" class="combo easyui-combobox" name="unitname" style="width: 170px;" data-options="panelHeight:'auto',editable: false,onSelect:function(rec){ var url = '../ajax/Srv_MaintainMaterial.ashx/GetMaintainMaterial_UnitAreaComboboxAll?unitname='+encodeURIComponent(rec.value);$('#areaid').combobox('reload', url); }">
                            <%if (roleid == 2)
                                { %>
                    ...
                    <td align="left">
                        <select id="" class="combo easyui-combobox" name="currentstock" style="width: 140px;" data-options="panelHeight:'auto',editable: false">
    ...
    <div data-options="region:'center',fit:true,border:false">
        <p class="sitepath">
            <b>当前位置：</b>运维物料管理 > <a href="javascript:void(0);">领料明细</a>
        </p>
