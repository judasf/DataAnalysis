    ...
    <script type="text/javascript">
        ...
        var addFun = function () {
            var dialog = parent.parent.$.modalDialog({
                ...
                height: 150,
                iconCls: 'icon-add',
                href: 'MaintainMaterial/dialogop/AreaInfo_OP.aspx', 
                buttons: [{
                    text: '添加',
                    handler: function () {
        ...
        var editFun = function (id) {
            var dialog = parent.$.modalDialog({
                ...
                height: 150,
                iconCls: 'icon-edit',
                href: 'MaintainMaterial/dialogop/AreaInfo_OP.aspx?id=' + id,
                buttons: [{
                    text: '保存',
                    handler: function () {
                        parent.onClassFormSubmit(dialog, grid);
        ...
        var removeFun = function (id) {
            parent.$.messager.confirm('询问', '您确定要删除此记录？', function (r) {
                if (r) {
                    $.post('../ajax/Srv_MaintainMaterial.ashx/RemoveAreaInfoByID', {
                        id: id
                    }, function (result) {
                        if (result.success) {
        ...
        $(function () {
            grid = $('#grid').datagrid({
                title: '领料单位表',
                url: '../ajax/Srv_MaintainMaterial.ashx/GetMaintainMaterialAreaInfo',
                striped: true,
                rownumbers: true,
                pagination: true,
                singleSelect: true,
...
<body class="easyui-layout">
    ...
    <div data-options="region:'center',fit:true,border:false">
        <p class="sitepath">
            <b>当前位置：</b>运维物料管理 > <a href="javascript:void(0);">领料单位管理</a>
        </p>
