    ...
    var onFormSubmit = function ($dialog, $grid) {
        if ($('form').form('validate')) {
            parent.$.messager.confirm('询问', '您确定要提交领料信息？提交后则不能修改！', function (r) {
                if (r) {
                    var url = 'ajax/Srv_MaintainMaterial.ashx/SaveUnitStockOutInfo';
                    //判断领料单上传
                    if ($('#report').val() == "") {
    ...
    $(function () {
        ...
        $('#faultorderno').blur(function () {
            ...
            if (faultorderno)//故障单号不为空
            {
                ...
                $.post('../ajax/Srv_MaintainMaterial.ashx/CheckFaultOrderNo', {
        ...
        <tr>
            <td style="text-align: left" colspan="7">领料日期：
                ...
                <input id="areaId" type="text" name="areaId" style="width: 140px;" class="combo easyui-combobox" data-options="
                    ...
                    required:true,
                    panelHeight: 'auto',
                    url: 'ajax/Srv_MaintainMaterial.ashx/GetMaintainMaterial_AreaInfoCombobox'
                      " />
