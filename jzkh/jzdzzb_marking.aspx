<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jzdzzb_marking.aspx.cs" Inherits="jzkh_jzdzzb_marking" %>
...
<body>
    ...
    <div id="content">
        <p class="sitepath">
            <b>当前位置：</b>基站考核管理 > <a href="jzdzzb_marking.aspx">基站断站指标考核</a>
        </p>
