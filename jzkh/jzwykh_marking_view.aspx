<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jzwykh_marking_view.aspx.cs"
    Inherits="jzkh_jzwykh_marking_view" %>
...
<body>
    ...
    <div id="content">
        <p class="sitepath">
            <b>当前位置：</b>基站考核管理 > <a href="jzkhtjb.aspx">基站外包维护质量考核表</a> >网优指标考核得分详情
        </p>
