<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jzrcwh_marking_view.aspx.cs"
    Inherits="jzkh_jzrcwh_marking_view" %>
...
<body>
    ...
    <div id="content">
        <p class="sitepath">
            <b>当前位置：</b>基站考核管理 > <a href="jzkhtjb.aspx">基站外包维护质量考核表</a> > 日常维护管理考核得分详情
        </p>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="left">
                         ...
                         <td align="left" valign="top" runat="server" id="addmemo">
                            <%#Eval("addmemo")%>
                        </td>
                    </tr>
                </ItemTemplate>
