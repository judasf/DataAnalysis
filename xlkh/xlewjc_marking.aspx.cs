...
public partial class xlkh_xlewjc_marking : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        sql.Append(" Update  xlkh_score set ewjc_score=" + total + " where deptname='" + deptname.Text + "' ");
        sql.Append(" and scoredate='" + scoredate.InnerText + "'");
        sql.Append(" ELSE ");
        sql.Append(" Insert into  xlkh_score(deptname,scoredate,ewjc_score) values('" + deptname.Text + "','" + scoredate.InnerText + "'," + total + ")");
