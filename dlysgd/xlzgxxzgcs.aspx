...
<body>
    ...
    <div id="content">
       <p class="sitepath">
            <b>当前位置：</b>电缆延伸事项管理 > <a href="xlzgxxgl.aspx">电缆延伸信息管理</a>> 区域维护电缆延伸措施录入
        </p>
        ...
        <tr><td colspan="4" class="btnp"><asp:Button ID="Button1" runat="server" Text="提交电缆延伸措施"  OnClientClick="return chkInput()"
