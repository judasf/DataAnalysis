...
public partial class xlzgxxzgcs : System.Web.UI.Page
{
    ...
    {
       string sql = "update dlysxx set zgcs='"+zgcs.Text+"',zgr='"+zgr.Text+"'  where id='" + zgid.InnerText + "'";
       DirectDataAccessor.Execute(sql);
        ClientScript.RegisterStartupScript(this.GetType(), "info", "alert('电缆延伸措施录入成功！');location.href='" + url + "'", true);
