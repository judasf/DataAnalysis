<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlzgxxlllr.aspx.cs" Inherits="xlzgxxlllr" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function chkInput() {
            ...
            //判断盘号begin
            if (ddlClass1.value == "1" || ddlClass1.value == "2") {
            ...
            if (ddlClass2.value != "0") {
                ...
                //判断盘号begin
                if (ddlClass2.value == "1" || ddlClass2.value == "2") {
                    ...
                    if (phkc2.value == "0" || (parseInt(amount2.value, 10) > parseInt(phkc2.value))) {
                        alert("当前盘号库存不足，无法领取，请确认输入的数量2是否正确！");
                        amount2.focus();
                        return false;
                    }
                }
            ...
            if (ddlClass3.value != "0") {
                ...
                //判断盘号begin
                if (ddlClass3.value == "1" || ddlClass3.value == "2") {
            ...
            if (ddlClass4.value != "0") {
                ...
                //判断盘号begin
                if (ddlClass4.value == "1" || ddlClass4.value == "2") {
            ...
            if (ddlClass5.value != "0") {
                ...
                //判断盘号begin
                if (ddlClass5.value == "1" || ddlClass5.value == "2") {
            ...
            if (ddlClass6.value != "0") {
                ...
                //判断盘号begin
                if (ddlClass6.value == "1" || ddlClass6.value == "2") {
...
<body>
    ...
    <div id="content">
        <p class="sitepath">
            <b>当前位置：</b>电缆延伸事项管理 > <a href="xlzgxxgl.aspx">电缆延伸信息管理</a>> 区域维护领料信息录入
        </p>
        <table cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" border="1" style="width:750px;">
            ...
            <tr>
                ...
                <td class="tdinput" style="background-color: #eeeeee;" id="zgid" runat="server">
                </td>
                <td class="tdtitle">
                    派单单位：
                </td>
                <td class="tdinput" style="background-color: #eeeeee;" id="pfdw" runat="server">
                </td>
            </tr>
            <tr>
                <td class="tdtitle">
                ...
                <td class="tdinput" style="background-color: #eeeeee;" id="pdr" runat="server">
                </td>
                <td class="tdtitle">
                    派单时间：
                </td>
                <td class="tdinput" style="background-color: #eeeeee;" id="pdsj" runat="server">
                </td>
            </tr>
            <tr>
                <td class="tdtitle">
                ...
                <td class="tdinput" style="background-color: #eeeeee;" id="lxrdh" runat="server">
                </td>
            </tr>
            <tr>
                <td class="tdtitle">
                ...
                <td class="tdinput" style="background-color: #eeeeee;" id="whdw" runat="server">
                </td>
                <td class="tdtitle">
                    负责人：
                </td>
            ...
            <tr>
                ...
                <td class="tdinput">
                    <asp:TextBox ID="lldw" runat="server"  ReadOnly="true"></asp:TextBox>
            ...
            <tr>
                <td colspan="4" align="center" class="btnp">
                    <asp:Button ID="Button1" runat="server" Text="提交区域维护领料信息" OnClientClick="return chkInput();"
