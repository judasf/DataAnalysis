...
public partial class xlzgqdqywh : System.Web.UI.Page
{
    ...
    {
        string sql = "update dlysxx set qywh='" + qywh.Text + "'  where id='" + zgid.InnerText + "'";
        DirectDataAccessor.Execute(sql);
        ClientScript.RegisterStartupScript(this.GetType(), "info", "alert('确定电缆延伸区域维护成功！');location.href='" + url + "'", true);
