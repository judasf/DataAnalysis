...
<body>
    ...
    <div id="content">
        <p class="sitepath">
            <b>当前位置：</b>电缆延伸事项管理 > <a href="xlzgxxgl.aspx">电缆延伸信息管理</a>>确定电缆延伸区域维护
        </p>
        <br />
        <table cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" border="1" class="tablewidth">
            ...
            <tr><td colspan="4" class="btnp"><asp:Button ID="Button1" runat="server" OnClientClick="return chkInput()" Text="确定电缆延伸区域维护" OnClick="Button1_Click" /></td></tr>
        </table>
