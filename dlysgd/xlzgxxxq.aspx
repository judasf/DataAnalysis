<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlzgxxxq.aspx.cs" Inherits="xlzgxxxq" %>
...
<body>
    ...
    <div id="content">
     <p class="sitepath">
            <b>当前位置：</b>电缆延伸事项管理 > <a href="xlzgxxgl.aspx">电缆延伸信息管理</a>> 电缆延伸通知书详情
        </p>
        <table cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" border="1" class="tablewidth" >
            ...
            <tr>
                ...
                <td class="tdinput" id="zgll" runat="server" colspan="3">
                </td>
