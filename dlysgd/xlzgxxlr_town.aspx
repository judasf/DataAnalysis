<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlzgxxlr_town.aspx.cs" Inherits="xlzgxxlr_town" %>
...
<body>
    ...
    <div id="content">
        <p class="sitepath">
            <b>当前位置：</b>电缆延伸事项管理 > <a href="xlzgxxgl.aspx">电缆延伸信息管理</a> > <a href="xlzgxxlr_town.aspx">
                电缆延伸信息录入</a>
        </p>
        <br />
        <table cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" border="1" class="tablewidth">
            ...
            <tr>
                ...
                <td class="tdinput" colspan="3">
                    <asp:TextBox ID="czwt" runat="server" Rows="4" MaxLength="2000" TextMode="MultiLine"
                        Width="441px"></asp:TextBox>
                    <span style="color: #F00;">*</span>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4" align="center" class="btnp">
                    <asp:Button ID="Button1" runat="server" Text="派发电缆延伸通知书" OnClientClick="return chkInput();"
