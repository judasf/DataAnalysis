...
<script type="text/javascript">
    var onFormSubmit = function ($dialog, $grid) {
        if ($('#resForm').form('validate')) {
            var url;
            if ($('#id').val().length == 0) {
                url = '../ajax/Srv_EnergyConsumption.ashx/SaveRetainStationElecInfo';
            } else {
                url = '../ajax/Srv_EnergyConsumption.ashx/UpdateRetainStationElecInfo';
            }
    ...
    $(function () {
        ...
        if ($('#id').val().length > 0) {
            ...
            $.post('../ajax/Srv_EnergyConsumption.ashx/GetRetainStationElecByID', {
                ID: $('#id').val()
            }, function (result) {
