...
public partial class nsbdxxfflr : System.Web.UI.Page
{
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        sjsj.InnerHtml = ds.Tables[0].Rows[0]["sjsj"].ToString();
                        sjje.InnerHtml = ds.Tables[0].Rows[0]["sjje"].ToString();
    ...
    {
        string sql = "update nsbdxx set ffsj='" + ffsj.Text + "'  where id='" + id.InnerText + "'";
        DirectDataAccessor.Execute(sql);
        ClientScript.RegisterStartupScript(this.GetType(), "info", "alert('成功提交付费信息！');location.href='" + url + "'", true);
