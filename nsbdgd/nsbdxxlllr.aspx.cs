...
public partial class nsbdxxlllr : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["uname"] == null || Session["uname"].ToString() == "" || Session["roleid"]==null)
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            lldw.Text = Request.QueryString["lldw"].ToString();
                            lldw.ReadOnly = true;
                        }
                        if (Request.QueryString["llr"] != null)
                        {
                            llr.Text = Request.QueryString["llr"].ToString();
                            llr.ReadOnly = true;
                        }
    ...
    {
        string sql = "select *  from  yjylkc_Class   where classname='南水北调'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //处理领料内容1
        if (PanHaoShow(ddlClass1.SelectedItem.Text, ddlType1.SelectedItem.Text))
        {
            sql.Append("insert into nsbdxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass1.SelectedItem.Text + "',");
            sql.Append("'" + ddlType1.SelectedItem.Text + "','" + ddlPanhao1.SelectedItem.Text + "','" + amount1.Text + "','" + units1_1.InnerHtml + "');");
            sql.Append("update yjylkc_kcmx set amount=amount-" + amount1.Text + " where classname='" + ddlClass1.SelectedItem.Text + "' and typename ='" + ddlType1.SelectedItem.Text + "' and panhao='" + ddlPanhao1.SelectedItem.Text + "' ;");
        ...
        else
        {
            ...
            sql.Append("update yjylkc_kcmx set amount=amount-" + amount1.Text + " where classname='" + ddlClass1.SelectedItem.Text + "' and typename ='" + ddlType1.SelectedItem.Text + "'; ");
        }
        //处理领料内容2
        if (ddlClass2.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into nsbdxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass2.SelectedItem.Text + "',");
                sql.Append("'" + ddlType2.SelectedItem.Text + "','" + ddlPanhao2.SelectedItem.Text + "','" + amount2.Text + "','" + units2_1.InnerHtml + "');");
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount2.Text + " where classname='" + ddlClass2.SelectedItem.Text + "' and typename =");
                sql.Append("'" + ddlType2.SelectedItem.Text + "' and panhao='" + ddlPanhao2.SelectedItem.Text + "' ;");
            ...
            else
            {
                ...
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount2.Text + " where classname='" + ddlClass2.SelectedItem.Text + "' and typename =");
                sql.Append(" '" + ddlType2.SelectedItem.Text + "'; ");
            }
        }
        //处理领料内容3
        if (ddlClass3.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into nsbdxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass3.SelectedItem.Text + "',");
                sql.Append("'" + ddlType3.SelectedItem.Text + "','" + ddlPanhao3.SelectedItem.Text + "','" + amount3.Text + "','" + units3_1.InnerHtml + "');");
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount3.Text + " where classname='" + ddlClass3.SelectedItem.Text + "' and typename =");
                sql.Append("'" + ddlType3.SelectedItem.Text + "' and panhao='" + ddlPanhao3.SelectedItem.Text + "' ;");
            ...
            else
            {
                ...
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount3.Text + " where classname='" + ddlClass3.SelectedItem.Text + "' and typename =");
                sql.Append(" '" + ddlType3.SelectedItem.Text + "'; ");
            }
        }
        //处理领料内容4
        if (ddlClass4.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into nsbdxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass4.SelectedItem.Text + "',");
                sql.Append("'" + ddlType4.SelectedItem.Text + "','" + ddlPanhao4.SelectedItem.Text + "','" + amount4.Text + "','" + units4_1.InnerHtml + "');");
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount4.Text + " where classname='" + ddlClass4.SelectedItem.Text + "' and typename =");
                sql.Append("'" + ddlType4.SelectedItem.Text + "' and panhao='" + ddlPanhao4.SelectedItem.Text + "' ;");
            ...
            else
            {
                ...
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount4.Text + " where classname='" + ddlClass4.SelectedItem.Text + "' and typename =");
                sql.Append(" '" + ddlType4.SelectedItem.Text + "'; ");
            }
        }
        //处理领料内容5
        if (ddlClass5.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into nsbdxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass5.SelectedItem.Text + "',");
                sql.Append("'" + ddlType5.SelectedItem.Text + "','" + ddlPanhao5.SelectedItem.Text + "','" + amount5.Text + "','" + units5_1.InnerHtml + "');");
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount5.Text + " where classname='" + ddlClass5.SelectedItem.Text + "' and typename =");
                sql.Append("'" + ddlType5.SelectedItem.Text + "' and panhao='" + ddlPanhao5.SelectedItem.Text + "' ;");
            ...
            else
            {
                ...
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount5.Text + " where classname='" + ddlClass5.SelectedItem.Text + "' and typename =");
                sql.Append(" '" + ddlType5.SelectedItem.Text + "'; ");
            }
        }
        //处理领料内容6
        if (ddlClass6.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into nsbdxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass6.SelectedItem.Text + "',");
                sql.Append("'" + ddlType6.SelectedItem.Text + "','" + ddlPanhao6.SelectedItem.Text + "','" + amount6.Text + "','" + units6_1.InnerHtml + "');");
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount6.Text + " where classname='" + ddlClass6.SelectedItem.Text + "' and typename =");
                sql.Append("'" + ddlType6.SelectedItem.Text + "' and panhao='" + ddlPanhao6.SelectedItem.Text + "' ;");
            ...
            else
            {
                ...
                sql.Append("update yjylkc_kcmx set amount=amount-" + amount6.Text + " where classname='" + ddlClass6.SelectedItem.Text + "' and typename =");
                sql.Append(" '" + ddlType6.SelectedItem.Text + "'; ");
            }
        }
        //写入sql日志
        DirectDataAccessor.writeLog("NSBD","SQ_", sql.ToString());
        DirectDataAccessor.Execute(sql.ToString());
        //设置南水北调信息领料状态
        DirectDataAccessor.Execute("update nsbdxx set qgll=1 where id='" + id.InnerText + "'");
        string script = "if (confirm('领料成功！是否继续领料？\\n点击确定继续领料，点击取消返回信息管理页面')){location.href=\"";
        script += "nsbdxxlllr.aspx?id=" + id.InnerText + "&cksj=" + cksj.Text + "&lldw=" + lldw.Text + "&llr=" + llr.Text + "&lxdh=" + lxdh.Text + "\";}";
        script += "else{location.href=\"nsbdxxgl.aspx\";}";
    ...
    {
        string sql = "select typeid,typename from yjylkc_Type where classid =" + ddlClass1.SelectedValue;
        DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
    ...
    protected void ddlType1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlType1.SelectedValue != "0")
        {
            ...
            {
                //隐藏盘号
                trPanhao1.Attributes.CssStyle["display"] = "none";
                string sql = "select units,amount from yjylkc_kcmx where classname='" + ddlClass1.SelectedItem.Text + "' and typename ='" + ddlType1.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
            ...
            else//有盘号
            {
                ...
                string sql = "select isnull(sum(amount),0) from yjylkc_kcmx where classname='" + ddlClass1.SelectedItem.Text + "' and typename ='" + ddlType1.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                kcamount1.Text = ds.Tables[0].Rows[0][0].ToString();
                sql = "select panhao,amount ,units from  yjylkc_kcmx where amount<>0 and classname='" + ddlClass1.SelectedItem.Text + "' and typename ='" + ddlType1.SelectedItem.Text + "'";
    ...
    {
        string sql = "select typeid,typename from yjylkc_Type where classid =" + ddlClass2.SelectedValue;
        DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
    ...
    protected void ddlType2_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlType2.SelectedValue != "0")
        {
            ...
            if (!PanHaoShow(ddlClass2.SelectedItem.Text, ddlType2.SelectedItem.Text))
            {
                trPanhao2.Attributes.CssStyle["display"] = "none";
                string sql = "select units,amount from yjylkc_kcmx where classname='" + ddlClass2.SelectedItem.Text + "' and typename ='" + ddlType2.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
            ...
            else ////有盘号
            {
                ...
                string sql = "select isnull(sum(amount),0) from yjylkc_kcmx where classname='" + ddlClass2.SelectedItem.Text + "' and typename ='" + ddlType2.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                kcamount2.Text = ds.Tables[0].Rows[0][0].ToString();
                sql = "select panhao,amount ,units from  yjylkc_kcmx where amount<>0 and classname='" + ddlClass2.SelectedItem.Text + "' and typename ='" + ddlType2.SelectedItem.Text + "'";
                ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
    ...
    protected void ddlClass3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sql = "select typeid,typename from yjylkc_Type where classid =" + ddlClass3.SelectedValue;
        DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
    ...
    protected void ddlType3_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlType3.SelectedValue != "0")
        {
            ...
            {
                //隐藏盘号
                trPanhao3.Attributes.CssStyle["display"] = "none";
                string sql = "select units,amount from yjylkc_kcmx where classname='" + ddlClass3.SelectedItem.Text + "' and typename ='" + ddlType3.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
            ...
            else//有盘号
            {
                ...
                string sql = "select isnull(sum(amount),0) from yjylkc_kcmx where classname='" + ddlClass3.SelectedItem.Text + "' and typename ='" + ddlType3.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                kcamount3.Text = ds.Tables[0].Rows[0][0].ToString();
                sql = "select panhao,amount ,units from  yjylkc_kcmx where amount<>0 and classname='" + ddlClass3.SelectedItem.Text + "' and typename ='" + ddlType3.SelectedItem.Text + "'";
                ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
    ...
    {
        string sql = "select typeid,typename from yjylkc_Type where classid =" + ddlClass4.SelectedValue;
        DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
    ...
    protected void ddlType4_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlType4.SelectedValue != "0")
        {
            ...
            {
                //隐藏盘号
                trPanhao4.Attributes.CssStyle["display"] = "none";
                string sql = "select units,amount from yjylkc_kcmx where classname='" + ddlClass4.SelectedItem.Text + "' and typename ='" + ddlType4.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
            ...
            else //有盘号
            {
                ...
                string sql = "select isnull(sum(amount),0) from yjylkc_kcmx where classname='" + ddlClass4.SelectedItem.Text + "' and typename ='" + ddlType4.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                kcamount4.Text = ds.Tables[0].Rows[0][0].ToString();
                sql = "select panhao,amount ,units from  yjylkc_kcmx where amount<>0 and classname='" + ddlClass4.SelectedItem.Text + "' and typename ='" + ddlType4.SelectedItem.Text + "'";
                ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
    ...
    protected void ddlClass5_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sql = "select typeid,typename from yjylkc_Type where classid =" + ddlClass5.SelectedValue;
        DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
    ...
    protected void ddlType5_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlType5.SelectedValue != "0")
        {
            ...
            {
                //隐藏盘号
                trPanhao5.Attributes.CssStyle["display"] = "none";
                string sql = "select units,amount from yjylkc_kcmx where classname='" + ddlClass5.SelectedItem.Text + "' and typename ='" + ddlType5.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
            ...
            else 
            {
                ...
                string sql = "select isnull(sum(amount),0) from yjylkc_kcmx where classname='" + ddlClass5.SelectedItem.Text + "' and typename ='" + ddlType5.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                kcamount5.Text = ds.Tables[0].Rows[0][0].ToString();
                sql = "select panhao,amount ,units from  yjylkc_kcmx where amount<>0 and classname='" + ddlClass5.SelectedItem.Text + "' and typename ='" + ddlType5.SelectedItem.Text + "'";
                ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
    ...
    protected void ddlClass6_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sql = "select typeid,typename from yjylkc_Type where classid =" + ddlClass6.SelectedValue;
        DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
    ...
    protected void ddlType6_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlType6.SelectedValue != "0")
        {
            ...
            {
                //隐藏盘号
                trPanhao6.Attributes.CssStyle["display"] = "none";
                string sql = "select units,amount from yjylkc_kcmx where classname='" + ddlClass6.SelectedItem.Text + "' and typename ='" + ddlType6.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
            ...
            else 
            {
                ...
                string sql = "select isnull(sum(amount),0) from yjylkc_kcmx where classname='" + ddlClass6.SelectedItem.Text + "' and typename ='" + ddlType6.SelectedItem.Text + "'";
                DataSet ds = DirectDataAccessor.QueryForDataSet(sql);
                kcamount6.Text = ds.Tables[0].Rows[0][0].ToString();
                sql = "select panhao,amount ,units from  yjylkc_kcmx where amount<>0 and classname='" + ddlClass6.SelectedItem.Text + "' and typename ='" + ddlType6.SelectedItem.Text + "'";
                ds = DirectDataAccessor.QueryForDataSet(sql);
                if (ds.Tables[0].Rows.Count > 0)
                {
