<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nsbdxxsjlr.aspx.cs" Inherits="nsbdxxsjlr" %>
...
<head runat="server">
   ...
   <script type="text/javascript" src="../Script/My97DatePicker/WdatePicker.js"></script>
    ...
    <script type="text/javascript">
        function chkInput() {
            var sjsj = document.getElementById("sjsj");
            if (sjsj.value.length <= 0) {
                alert("请选择审计时间！");
                sjsj.focus();
                return false;
            }

            var sjje = document.getElementById("sjje");
            if (sjje.value.length <= 0) {
                alert("请录入审计金额！");
                sjje.focus();
                return false;
            } else if (/[^0-9\.]/.test(sjje.value)) {
            alert("录入的审计金额有误，请重新输入！");
            sjje.focus();
                return false;
            }
...
<body>
    ...
    <div id="content">
       <p class="sitepath">
            <b>当前位置：</b>南水北调事项处理 >  <%=Session["pre"] != null&&Session["pre"].ToString().Trim()==""?"<a href=\"nsbdxxgl.aspx\">市区南水北调信息管理</a>":"<a href=\"nsbdxxgl_town.aspx\">县公司南水北调信息管理</a>" %>> 南水北调工单审计
        </p>
        <br />
    ...
    <tr>
            ...
            <tr>
                ...
                <td class="tdinput" >
                <asp:TextBox   ID="sjsj" runat="server" class="Wdate" onFocus="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})" ></asp:TextBox>
                ...
                <td class="tdinput" >
                    <asp:TextBox ID="sjje" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td colspan="4" align="center" class="btnp">
                    <asp:Button ID="Button1" runat="server" Text="提交南水北调审计信息" OnClientClick="return chkInput();"
