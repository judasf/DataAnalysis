<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nsbdxxfflr.aspx.cs" Inherits="nsbdxxfflr" %>
...
<body>
    ...
    <div id="content">
       <p class="sitepath">
            <b>当前位置：</b>南水北调事项处理 >  <%=Session["pre"] != null&&Session["pre"].ToString().Trim()==""?"<a href=\"nsbdxxgl.aspx\">市区南水北调信息管理</a>":"<a href=\"nsbdxxgl_town.aspx\">县公司南水北调信息管理</a>" %>> 南水北调工单付费
        </p>
    ...
    <tr>
            ...
            <tr>
                <td colspan="4" align="center" class="btnp">
                    <asp:Button ID="Button1" runat="server" Text="提交南水北调付费信息" OnClientClick="return chkInput();"
