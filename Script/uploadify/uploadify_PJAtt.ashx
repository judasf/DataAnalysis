...
public class uploadify : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        //保存文件夹
        string floderName = rootFloder+@"\repairAtt\" + DateTime.Now.ToString("yyyyMMdd") + @"\";
        //文件夹路径
        string floderPath = Server.MapPath("~") + rootFloder + @"\repairAtt\" + DateTime.Now.ToString("yyyyMMdd") + @"\";
        //上传的文件
        ...
        //文件相对路径
        string retrunFilePath = rootFloder + "/repairAtt/" + DateTime.Now.ToString("yyyyMMdd") + "/" + newFileName;
        if(file != null)
        {
