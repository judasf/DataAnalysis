    ...
    <script type="text/javascript">
        ...
        $(function () {
            resourcesGrid = $('#resourcesGrid').datagrid({
                title: '操作记录统计',
                url: '../ajax/Srv_AccessNetwork.ashx/GetOPStatistics',
                striped: true,
                rownumbers: true,
                pagination: false,
                noheader: true,
...
<body class="easyui-layout">
            ...
            <table>
                <tr>
                    <td style="width: 80px; font-weight: 700;">数据查询：</td>
                      <td style="width: 65px; text-align: right;">操作日期：
                    </td>
                    <td>
    ...
    <div data-options="region:'center',fit:true,border:false">
        <p class="sitepath">
            <b>当前位置：</b>接入网资源管理 > <a href="javascript:void(0);">操作记录统计</a>
        </p>
