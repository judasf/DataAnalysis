...
public partial class right : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["uname"] == null || Session["uname"].ToString() == "" || Session["deptname"] == null || Session["roleid"] == null||Session["_token"] == null|| Request.Cookies["_token"]==null)
                Response.Write("<script type='text/javascript'>alert('请重新登陆！');top.location.href='logout.aspx';</script>");
            else
            {
                token = Request.Cookies["_token"].Value;
