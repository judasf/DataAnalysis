    ...
    <script type="text/javascript">
        ...
        var addFun = function () {
            var dialog = parent.parent.$.modalDialog({
                ...
                height: 180,
                iconCls: 'icon-add',
                href: 'ResourceReuse/dialogop/RRTypeInfo_OP.aspx', //将对话框内容添加到父页面
                buttons: [{
                    text: '添加',
                    handler: function () {
        ...
        var editFun = function (id) {
            var dialog = parent.$.modalDialog({
                ...
                height: 180,
                iconCls: 'icon-edit',
                href: 'ResourceReuse/dialogop/RRTypeInfo_OP.aspx?id=' + id,
                buttons: [{
                    text: '保存',
                    handler: function () {
                        parent.onClassFormSubmit(dialog, grid);
        ...
        var removeFun = function (id) {
            parent.$.messager.confirm('询问', '您确定要删除此型号？', function (r) {
                if (r) {
                    $.post('../ajax/Srv_ResourceReuse.ashx/RemoveTypeInfoByID', {
                        id: id
                    }, function (result) {
                        if (result.success) {
        ...
        $(function () {
            ...
            grid = $('#grid').datagrid({
                title: '资源类别表',
                url: '../ajax/Srv_ResourceReuse.ashx/GetRRTypeInfo',
                striped: true,
                rownumbers: true,
                pagination: true,
                singleSelect: true,
...
<body class="easyui-layout">
        ...
        <form id="searchForm" style="margin: 0;">
            <table style="table-layout: auto;">
                <tr>
                    ...
                    <%} %>
                    <td style="width: 65px; text-align: right;">资源类别：
                    </td>
                    <td align="left">
                        <input name="typeid" id="typeid" class="combo" style="width: 200px;" />
                    </td>
                    <td>
    ...
    <div data-options="region:'center',fit:true,border:false">
        <p class="sitepath">
            <b>当前位置：</b>运维物料管理 > <a href="javascript:void(0);">资源类别管理</a>
        </p>
