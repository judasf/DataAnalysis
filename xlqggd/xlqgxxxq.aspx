<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlqgxxxq.aspx.cs" Inherits="xlqgxxxq" %>
...
<body>
    ...
    <div id="content">
        <p class="sitepath">
            <b>当前位置：</b>迁改事项管理 > <%=Session["pre"] != null&&Session["pre"].ToString().Trim()==""?"<a href=\"xlqgxxgl.aspx\">市区迁改信息管理</a>":"<a href=\"xlqgxxgl_town.aspx\">县公司迁改信息管理</a>" %>> 迁改信息详情
        </p>
        <br />
        <table cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" border="1"  class="tablewidth">
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="tdinput" colspan="3">
                    <asp:Label ID="qgxczp" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="tdtitle">
            ...
            <tr>
                ...
                <td class="tdinput" colspan="3">
                    <asp:Label ID="qgwjxc" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr style="background-color: #eeeeee; line-height: 30px;">
                <td colspan="4" align="center">
