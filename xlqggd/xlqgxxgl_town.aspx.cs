...
public partial class xlqgxxgl_town : System.Web.UI.Page
{
    /// <summary>
    /// 判断是否运维部超管
    /// </summary>
            ...
            else
            {
                ...
                if (Request.QueryString["action"] == "del")
                {
                    ...
                    else
                    {
                        ...
                        ClientScript.RegisterStartupScript(this.GetType(), "info", "alert('删除成功！'); location.href='xlqgxxgl_town.aspx';", true);
