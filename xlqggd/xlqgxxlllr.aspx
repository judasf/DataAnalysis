<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlqgxxlllr.aspx.cs" Inherits="xlqgxxlllr" %>
...
<body>
    ...
    <div id="content">
       <p class="sitepath">
            <b>当前位置：</b>迁改事项处理 >  <%=Session["pre"] != null&&Session["pre"].ToString().Trim()==""?"<a href=\"xlqgxxgl.aspx\">市区迁改信息管理</a>":"<a href=\"xlqgxxgl_town.aspx\">县公司迁改信息管理</a>" %>> 迁改领料信息录入
        </p>
        <table cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" border="1" style="width: 750px;">
            ...
            <tr>
                <td colspan="4" align="center" class="btnp">
                    <asp:Button ID="Button1" runat="server" Text="录入迁改领料信息" OnClientClick="return chkInput();"
