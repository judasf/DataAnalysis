...
public partial class xlqgxxlllr : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            sql.Append("insert into xlqgxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass1.SelectedItem.Text + "',");
            sql.Append("'" + ddlType1.SelectedItem.Text + "','" + ddlPanhao1.SelectedItem.Text + "','" + amount1.Text + "','" + units1_1.InnerHtml + "');");
            sql.Append("update " + Session["pre"].ToString() + "yjylkc_kcmx set amount=amount-" + amount1.Text + " where classname='" + ddlClass1.SelectedItem.Text + "' and typename ='" + ddlType1.SelectedItem.Text + "' and panhao='" + ddlPanhao1.SelectedItem.Text + "' ;");
        ...
        else
        {
            ...
            sql.Append("update " + Session["pre"].ToString() + "yjylkc_kcmx set amount=amount-" + amount1.Text + " where classname='" + ddlClass1.SelectedItem.Text + "' and typename ='" + ddlType1.SelectedItem.Text + "'; ");
        }
        //处理领料内容2
        if (ddlClass2.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqgxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass2.SelectedItem.Text + "',");
                sql.Append("'" + ddlType2.SelectedItem.Text + "','" + ddlPanhao2.SelectedItem.Text + "','" + amount2.Text + "','" + units2_1.InnerHtml + "');");
                sql.Append("update " + Session["pre"].ToString() + "yjylkc_kcmx set amount=amount-" + amount2.Text + " where classname='" + ddlClass2.SelectedItem.Text + "' and typename =");
        ...
        if (ddlClass3.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqgxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass3.SelectedItem.Text + "',");
                sql.Append("'" + ddlType3.SelectedItem.Text + "','" + ddlPanhao3.SelectedItem.Text + "','" + amount3.Text + "','" + units3_1.InnerHtml + "');");
                sql.Append("update " + Session["pre"].ToString() + "yjylkc_kcmx set amount=amount-" + amount3.Text + " where classname='" + ddlClass3.SelectedItem.Text + "' and typename =");
        ...
        if (ddlClass4.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqgxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass4.SelectedItem.Text + "',");
                sql.Append("'" + ddlType4.SelectedItem.Text + "','" + ddlPanhao4.SelectedItem.Text + "','" + amount4.Text + "','" + units4_1.InnerHtml + "');");
                sql.Append("update " + Session["pre"].ToString() + "yjylkc_kcmx set amount=amount-" + amount4.Text + " where classname='" + ddlClass4.SelectedItem.Text + "' and typename =");
        ...
        if (ddlClass5.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqgxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass5.SelectedItem.Text + "',");
                sql.Append("'" + ddlType5.SelectedItem.Text + "','" + ddlPanhao5.SelectedItem.Text + "','" + amount5.Text + "','" + units5_1.InnerHtml + "');");
                sql.Append("update " + Session["pre"].ToString() + "yjylkc_kcmx set amount=amount-" + amount5.Text + " where classname='" + ddlClass5.SelectedItem.Text + "' and typename =");
        ...
        if (ddlClass6.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqgxx_llmx values('" + id.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass6.SelectedItem.Text + "',");
                sql.Append("'" + ddlType6.SelectedItem.Text + "','" + ddlPanhao6.SelectedItem.Text + "','" + amount6.Text + "','" + units6_1.InnerHtml + "');");
                sql.Append("update " + Session["pre"].ToString() + "yjylkc_kcmx set amount=amount-" + amount6.Text + " where classname='" + ddlClass6.SelectedItem.Text + "' and typename =");
        ...
        //写入sql日志
        DirectDataAccessor.writeLog("QG", Session["pre"].ToString() == "" ? "SQ_" : Session["pre"].ToString(), sql.ToString());
        DirectDataAccessor.Execute(sql.ToString());
        //设置迁改信息领料状态
        DirectDataAccessor.Execute("update xlqgxx set qgll=1 where id='" + id.InnerText + "'");
        string script = "if (confirm('领料成功！是否继续领料？\\n点击确定继续领料，点击取消返回信息管理页面')){location.href=\"";
        script += "xlqgxxlllr.aspx?id=" + id.InnerText + "&cksj=" + cksj.Text + "&lldw=" + Server.UrlEncode(lldw.Text) + "&llr=" +Server.UrlEncode(llr.Text) + "&lxdh=" + lxdh.Text + "\";}";
        if (Session["pre"]!=null && Session["pre"].ToString().Trim()=="")
        script += "else{location.href=\"xlqgxxgl.aspx\";}";
        if (Session["pre"] != null && Session["pre"].ToString().Trim() != "")
            script += "else{location.href=\"xlqgxxgl_town.aspx\";}";
