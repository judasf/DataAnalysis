...
using System.Text;
using System.Data;
public partial class Marks_e : System.Web.UI.Page
{
    ...
    {
        //判断部门当月是已打分
        string isMarkSql = "select *  from ywbkh_marking where itemid='e' and markinguser='" + Session["uname"].ToString() + "' and scoremonth='" + markmonth.InnerText + "'";
        ...
        else
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "info", "alert('对工作效率考核成功！');location.href=location.href;", true);
