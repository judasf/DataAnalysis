...
using System.Text;
using System.Data;
public partial class View_f : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                sql.Append("select a.uname,a.score as score1,b.score as score2 from ywbkh_marking as a join ywbkh_marking as b on a.uname=b.uname " );
                sql.Append(" where a.itemid='f1' and b.itemid='f2'  and b.scoremonth='" + scoreDate + "'  and a.scoremonth='" + scoreDate + "'");
