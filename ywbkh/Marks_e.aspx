<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Marks_e.aspx.cs" Inherits="Marks_e" %>
                                ...
                                <td>
                                    ...
                                    <table style="border-collapse: collapse" bordercolor="#6a71a3" cellspacing="1" cellpadding="3"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="3">
                                                    <b>工作效率</b>：不能按时按要求完成本岗位工作任务（周工作计划内容、日常工作内容），效率低的每次每项扣2分 。
