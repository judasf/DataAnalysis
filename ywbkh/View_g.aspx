<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_g.aspx.cs" Inherits="View_g" %>
    ...
    <table border="2" width="100%" height="100%" cellpadding="6" cellspacing="0" bgcolor="#F5F5FF"
        ...
        <tr>
            <td bgcolor="#F5F5FF" align="center" valign="top">
                <p align="left">
                    <b>评分月份：<%=Request.QueryString["ym"] %></b></p>
                <b id="noScore" style="display: none;">本月分数尚未填写！</b>
                <table border="1" width="50%" cellspacing="1" cellpadding="3" style="border-collapse: collapse;"
