...
public partial class zwkh_zwzayfw_marking : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        sql.Append(" Update  zwkh_score set zayfw_score=" + (85 - total) * ratio + " where deptname='" + deptname.Text + "' ");
        sql.Append(" and scoredate='" + scoredate.InnerText + "'");
        sql.Append(" ELSE ");
        sql.Append(" Insert into  zwkh_score(deptname,scoredate,zayfw_score) values('" + deptname.Text + "','" + scoredate.InnerText + "'," + (85 - total) * ratio + ")");
