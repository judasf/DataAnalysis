<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zwzayfw_marking.aspx.cs" Inherits="zwkh_zwzayfw_marking" %>
        ...
        <script type="text/javascript">
            function chkInput() {
                ...
                for (var i = 0; i < num; i++) {
                    ...
                    //if (Number(txtScore.value) > Number(lblMarks.innerText)) {
                ...
                if (total > 85) {
                    alert("扣分已超过85分，请检查您的输入！");
                    return false;
                }
                    if (confirm("扣分为："+total+"，得分为："+(85-total)+"。确认提交考核分数？"))
                    return true;
                else
                    return false;
            }
...
<body>
    ...
    <div id="content">
        <p class="sitepath">
            <b>当前位置：</b>装维考核管理 > <a href="xlzayfw_marking.aspx">障碍与服务指标考核</a>
        </p>
