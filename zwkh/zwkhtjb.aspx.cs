...
public partial class zwkh_zwkhtjb : System.Web.UI.Page
{
    ...
    {
        DataSet ds = DirectDataAccessor.QueryForDataSet("select distinct  scoredate from zwkh_score ");
    ...
    private string GetSqlStr()
    {
        ...
        StringBuilder sql = new StringBuilder("select a.deptname,wbdw,isnull(zayfw_score,0)as s1,isnull(jcgl_score,0) as s2,");
        sql.Append("isnull(ewjc_score,0) as s3");
        sql.Append(",isnull((zayfw_score+jcgl_score+ewjc_score),0) as s4");
        sql.Append(" from zwkh_deptinfo as a left join zwkh_score as b on a.deptname=b.deptname ");
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        ...
        outputFileName += "装维外包维护质量考核表.xls";
