<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlbdxxlllr.aspx.cs" Inherits="xlbdxxlllr" %>
...
<body>
    ...
    <div id="content">
         <p class="sitepath">
            <b>当前位置：</b>被盗事项管理 > <a href="xlbdxxgl.aspx">被盗信息管理</a>>被盗领料信息录入
        </p>
        ...
        <table cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" border="1" style="width:750px;">
            ...
            <tr>
                <td colspan="4" align="center" class="btnp">
                    <asp:Button ID="Button1" runat="server" Text="录入被盗领料信息" OnClientClick="return chkInput();"
