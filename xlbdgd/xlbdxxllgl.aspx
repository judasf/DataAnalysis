<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlbdxxllgl.aspx.cs" Inherits="xlbdxxllgl" %>
...
<body>
    <form id="form1" runat="server">
        <div id="content">
            <p class="sitepath">
                <b>当前位置：</b>被盗事项管理 > <a href="xlbdxxllgl.aspx">被盗领料信息管理</a>
            </p>
         ...
         <b>被盗编号：</b><asp:TextBox ID="bdid" runat="server"></asp:TextBox>
