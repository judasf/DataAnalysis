...
<script type="text/javascript">
    ...
    var showMaterialList = function (repairorderno) {
        $.post('../ajax/Srv_NetWorkSpecialProject.ashx/GetRepairMaterialListByNo', { no: repairorderno }, function (nodeRes) {
            if (nodeRes.total > 0) {
    ...
    $(function () {
        if ($('#id').val().length > 0) {
            ...
            $.post('../ajax/Srv_NetWorkSpecialProject.ashx/GetDailyRepairInfoByID', {
                ID: $('#id').val()
            }, function (result) {
