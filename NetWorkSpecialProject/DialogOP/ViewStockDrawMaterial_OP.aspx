...
<script type="text/javascript">
    ...
    var exportMaterialInfo = function () {
        jsPostForm('../ajax/Srv_NetWorkSpecialProject.ashx/ExportStockDrawMaterialInfo?id=' + $('#id').val(), $.serializeObject($('#searchForm')));
    };
    ...
    $(function () {
        drawMaterialGrid = $('#drawMaterialGrid').datagrid({
            title: '用料明细',
            url: '../ajax/Srv_NetWorkSpecialProject.ashx/GetStockDrawMaterialInfo?id=' + $('#id').val(),
            striped: true,
            rownumbers: true,
            pagination: true,
            noheader: true,
