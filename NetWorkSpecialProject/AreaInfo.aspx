    ...
    <script type="text/javascript">
        ...
        var addFun = function () {
            var dialog = parent.parent.$.modalDialog({
                ...
                height: 150,
                iconCls: 'icon-add',
                href: 'NetWorkSpecialProject/dialogop/AreaInfo_OP.aspx', 
                buttons: [{
                    text: '添加',
                    handler: function () {
        ...
        var editFun = function (id) {
            var dialog = parent.$.modalDialog({
                ...
                height: 150,
                iconCls: 'icon-edit',
                href: 'NetWorkSpecialProject/dialogop/AreaInfo_OP.aspx?id=' + id,
                buttons: [{
                    text: '保存',
                    handler: function () {
                        parent.onClassFormSubmit(dialog, grid);
        ...
        var removeFun = function (id) {
            parent.$.messager.confirm('询问', '您确定要删除此记录？', function (r) {
                if (r) {
                    $.post('../ajax/Srv_NetWorkSpecialProject.ashx/RemoveAreaInfoByID', {
                        id: id
                    }, function (result) {
                        if (result.success) {
...
<body class="easyui-layout">
    ...
    <div data-options="region:'center',fit:true,border:false">
        <p class="sitepath">
            <b>当前位置：</b>专项整治管理 > <a href="javascript:void(0);">领料单位管理</a>
        </p>
