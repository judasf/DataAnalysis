    ...
    <script type="text/javascript">
        ...
        var viewRepairMaterialDetail = function (id) {
            var dialog = parent.$.modalDialog({
                ...
                href: 'NetWorkSpecialProject/DialogOP/ViewStockDrawMaterial_OP.aspx?id=' + id,
                buttons: [{
                    text: '关闭',
                    handler: function () {
                        dialog.dialog('close');
        ...
        $(function () {
            ...
            grid = $('#grid').datagrid({
                title: '领料明细',
                url: '../ajax/Srv_NetWorkSpecialProject.ashx/GetUnitDrawStockDetail',
                striped: true,
                rownumbers: true,
                pagination: true,
                singleSelect: true,
...
<body class="easyui-layout" style="overflow: hidden;">
        ...
        <form id="searchForm" style="margin: 0;">
            <table>
                <tr>
                    ...
                    <td>
                        <select id="classname" class="combo easyui-combobox" name="classname" style="width: 140px;" data-options="panelHeight:'auto',editable: false,onSelect:function(rec){ var url = '../ajax/Srv_NetWorkSpecialProject.ashx/GetNSP_MaintainMaterial_TypeInfoComboboxAll?classname='+encodeURIComponent(rec.value);$('#typeid').combobox('reload', url); }">
                ...
                <tr>
                    ...
                    <td>
                        <select id="unitname" class="combo easyui-combobox" name="unitname" style="width: 170px;" data-options="panelHeight:'auto',editable: false,onSelect:function(rec){ var url = '../ajax/Srv_NetWorkSpecialProject.ashx/GetNetWorkSpecialProject_UnitAreaComboboxAll?unitname='+encodeURIComponent(rec.value);$('#areaid').combobox('reload', url); }">
                            <%if (roleid == 2)
                                { %>
    ...
    <div data-options="region:'center',fit:true,border:false">
        <p class="sitepath">
            <b>当前位置：</b>专项整治管理 > <a href="javascript:void(0);">物料领用管理</a>
        </p>
