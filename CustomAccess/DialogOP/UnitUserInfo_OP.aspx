...
<script type="text/javascript">
    ...
    var onFormSubmit = function ($dialog, $grid) {
        if ($('form').form('validate')) {
            var url;
            if ($('#UID').val().length == 0) {
                url = 'ajax/Srv_CustomAccess.ashx/SaveUnitUserInfo';
            } else {
                url = 'ajax/Srv_CustomAccess.ashx/UpdateUnitUserInfo';
            }
    ...
    $(function () {
        ...
        $('#roleId').combobox({
            ...
            editable: false,
            panelHeight: 'auto',
            data: [ { id: '31', text: '库管员' }, { id: '32', text: '领料工号' }],
        ...
        if ($('#UID').val().length > 0) {
            ...
            $.post('ajax/Srv_CustomAccess.ashx/GetUnitUserInfoByID', {
                UID: $('#UID').val()
            }, function (result) {
