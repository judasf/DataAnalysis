...
<head>
    ...
    <script type="text/javascript">
        ...
        var exportInStockDetail = function () {
            jsPostForm('../ajax/Srv_CustomAccess.ashx/ExportUnitInStockDetail', $.serializeObject($('#searchForm')));
        };
        $(function () {
            grid = $('#grid').datagrid({
                title: '物料入库明细',
                url: '../ajax/Srv_CustomAccess.ashx/GetUnitInStockDetail',
                striped: true,
                rownumbers: true,
                pagination: true,
                singleSelect: true,
...
<body class="easyui-layout" style="overflow: hidden;">
    ...
    <div data-options="region:'center',fit:true,border:false">
        <p class="sitepath">
            <b>当前位置：</b>客户接入物料管理 > <a href="javascript:void(0);">客户接入——物料入库明细</a>
        </p>
