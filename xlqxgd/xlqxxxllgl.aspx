<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlqxxxllgl.aspx.cs" Inherits="xlqxxxllgl" %>
...
<body>
    ...
    <div id="content">
       <p class="sitepath">
            <b>当前位置：</b>抢修事项管理 > <a href="xlqxxxllgl.aspx">抢修领料信息管理</a>
        </p>
        <p style="text-align: left;">
         ...
         <b>抢修编号：</b><asp:TextBox ID="qxid" runat="server"></asp:TextBox>
