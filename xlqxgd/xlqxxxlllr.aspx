<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlqxxxlllr.aspx.cs" Inherits="xlqxxxlllr" %>
...
<body>
    ...
    <div id="content">
       <p class="sitepath"><b>当前位置：</b>抢修事项管理 > <a href="xlqxxxgl.aspx">抢修信息管理</a>> 抢修领料信息录入</p>
        ...
        <table cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" border="1" style="width: 750px;">
            ...
            <tr>
                ...
                <td class="tdinput" style="background-color: #eeeeee;">
            ...
            <tr>
                ...
                <td class="tdinput" colspan="3" style="background-color: #eeeeee;">
            ...
            <tr>
                <td colspan="4" align="center" class="btnp">
                    <asp:Button ID="Button1" runat="server" Text="录入抢修领料信息" OnClientClick="return chkInput();"
