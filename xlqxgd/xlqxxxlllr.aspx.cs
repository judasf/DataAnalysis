...
public partial class xlqxxxlllr : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                {
                    qxid.Text = Request.QueryString["id"].ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            sql.Append("insert into xlqxxx_llmx values('" + qxid.Text + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass1.SelectedItem.Text + "',");
        ...
        if (ddlClass2.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqxxx_llmx values('" + qxid.Text + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass2.SelectedItem.Text + "',");
        ...
        if (ddlClass3.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqxxx_llmx values('" + qxid.Text + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass3.SelectedItem.Text + "',");
        ...
        if (ddlClass4.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqxxx_llmx values('" + qxid.Text + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass4.SelectedItem.Text + "',");
        ...
        if (ddlClass5.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqxxx_llmx values('" + qxid.Text + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass5.SelectedItem.Text + "',");
        ...
        if (ddlClass6.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlqxxx_llmx values('" + qxid.Text + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass6.SelectedItem.Text + "',");
        ...
        //写入sql日志
        DirectDataAccessor.writeLog("QX", Session["pre"].ToString() == "" ? "SQ_" : Session["pre"].ToString(), sql.ToString());
        DirectDataAccessor.Execute(sql.ToString());
        //设置抢修信息领料状态
        DirectDataAccessor.Execute("update xlqxxx set qxll=1 where id='" + qxid.Text + "'");
        string script = "if (confirm('领料成功！是否继续领料？\\n点击确定继续领料，点击取消返回信息管理页面')){location.href=\"";
        script += "xlqxxxlllr.aspx?id=" + qxid.Text + "&cksj=" + cksj.Text + "&lldw=" +Server.UrlEncode(lldw.Text) + "&llr=" +Server.UrlEncode(llr.Text) + "&lxdh=" + lxdh.Text + "\";}";
        script += "else{location.href=\"xlqxxxgl.aspx\";}";
