...
public partial class xlzgxxlllr : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            sql.Append("insert into xlzgxx_llmx values('" + zgid.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass1.SelectedItem.Text + "',");
        ...
        if (ddlClass2.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlzgxx_llmx values('" + zgid.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass2.SelectedItem.Text + "',");
        ...
        if (ddlClass3.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlzgxx_llmx values('" + zgid.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass3.SelectedItem.Text + "',");
        ...
        if (ddlClass4.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlzgxx_llmx values('" + zgid.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass4.SelectedItem.Text + "',");
        ...
        if (ddlClass5.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlzgxx_llmx values('" + zgid.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass5.SelectedItem.Text + "',");
        ...
        if (ddlClass6.SelectedValue != "0")
        {
            ...
            {
                sql.Append("insert into xlzgxx_llmx values('" + zgid.InnerText + "','" + cksj.Text + "','" + lldw.Text + "','" + llr.Text + "','" + lxdh.Text + "','" + ddlClass6.SelectedItem.Text + "',");
        ...
        //写入sql日志
        DirectDataAccessor.writeLog("ZG_GD", Session["pre"].ToString() == "" ? "SQ_" : Session["pre"].ToString(), sql.ToString());
        DirectDataAccessor.Execute(sql.ToString());
        //设置被盗信息领料状态
        DirectDataAccessor.Execute("update xlzgxx set zgll=1 where id='" + zgid.InnerText + "'");
