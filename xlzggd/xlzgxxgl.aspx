<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlzgxxgl.aspx.cs" Inherits="xlzgxxgl" ValidateRequest="true" %>
...
<body>
    <form id="form1" runat="server">
        <div id="content">
            <p class="sitepath">
                <b>当前位置：</b>整改事项管理 > <a href="xlzgxxgl.aspx">市区整改信息管理</a>
            </p>
            ...
            <asp:DropDownList ID="ddlqywh" runat="server">
                ...
                工单状态：<asp:DropDownList
                    ...
                    <asp:ListItem Value='zgcs'>整改措施未录入</asp:ListItem>
            ...
            <table cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" border="1" style="table-layout: fixed;">
                <tr style="background-color: #eeeeee; line-height: 30px;">
                    ...
                    <td width="100">整改完结并复查
                    </td>
                    <td width="80">是否退料
                    </td>
                    <td width="40" <%=isAdminYW?"":"style='display:none'" %>>操作
                    </td>
                </tr>
                <asp:Repeater ID="repData" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%#handleWBZGWJ(Eval("id").ToString(), Eval("wjsj").ToString(), Eval("xgqr").ToString())%>
                            </td>
                            <td>
                                <%#handleKGQR(Eval("id").ToString(), Eval("kgck").ToString(), Eval("xgqr").ToString())%>
                            </td>
                            <td>
