<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xlzgxxwbzgwj.aspx.cs" Inherits="xlzgxxwj" %>
...
<body>
    ...
    <div id="content">
        <p class="sitepath">
            <b>当前位置：</b>整改事项管理 > <a href="xlzgxxgl.aspx">整改信息管理</a>>外包单位设置整改完结时间
        </p>
        <table border="1" bordercolor="#CCCCCC" cellpadding="0" cellspacing="0" class="tablewidth">
            ...
            <tr>
                ...
                <td class="tdinput" colspan="3">
                   <%-- <asp:TextBox ID="wjsj" runat="server" class="Wdate" onFocus="WdatePicker({isShowClear:'false',readOnly:'true',dateFmt:'yyyy-MM-dd HH:mm:ss'})"></asp:TextBox>--%>
                   <asp:TextBox ID="wjsj" runat="server"  ReadOnly="true"></asp:TextBox>
                    <span style="color: #F00;">*</span>
                   
                </td>
            </tr>
            <tr><td colspan="4" class="btnp">  <asp:Button ID="Button1" runat="server" Text="设置整改完结时间" OnClientClick="return chkInput()"
