<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yjylkckclrmx.aspx.cs" Inherits="yjylkckclrmx" %>
...
<body>
    <form id="form1" runat="server">
        <div id="content">
            <p class="sitepath"><b>当前位置：</b>库存管理 > <a href="yjylkckctjb.aspx">库存统计表</a> > 库存录入明细 </p>
            <p style="text-align: left;">
               ...
               <asp:TextBox runat="server" Style="width: 65px;" ID="ddlMonth1" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM',readOnly:'true'})"></asp:TextBox>
                &nbsp; &nbsp;选择类别：<asp:DropDownList ID="ddlClass" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlClass_SelectedIndexChanged">
                </asp:DropDownList>
                &nbsp; &nbsp;
            选择型号：<asp:DropDownList ID="ddlType" runat="server">
                <asp:ListItem Value="0">---------------全部---------------</asp:ListItem>
            </asp:DropDownList>
                &nbsp; &nbsp;
             选择市县：<asp:DropDownList ID="ddlpre" runat="server">
             </asp:DropDownList>
