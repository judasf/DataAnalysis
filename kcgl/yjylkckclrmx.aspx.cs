...
public partial class yjylkckclrmx : System.Web.UI.Page
{
    ...
    private DataTable GetDataTable()
    {
        ...
        if (Request.QueryString["qj"] != null)
        {
            ...
            whereStr += "  substring(CONVERT(varchar(20), inputtime, 23),0,8)>='" + Request.QueryString["qj"].ToString() + "' and";
        }else
            whereStr += "  substring(CONVERT(varchar(20), inputtime, 23),0,8)>='" + DateTime.Now.AddMonths(-1).ToString("yyyy-MM") + "' and";
        if (Request.QueryString["jz"] != null)
        {
            ddlMonth1.Text = Request.QueryString["jz"].ToString();
            whereStr += "  substring(CONVERT(varchar(20), inputtime, 23),0,8)<='" + Request.QueryString["jz"].ToString() + "' and";
        }
        else
            whereStr += "  substring(CONVERT(varchar(20), inputtime, 23),0,8)<='" + DateTime.Now.ToString("yyyy-MM") + "' and";
